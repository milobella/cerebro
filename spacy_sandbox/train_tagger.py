...
TRAIN_DATA = [
    ("je veux rajouter des oeufs à ma liste", {'tags': ['', 'V', 'V', '', 'N', '', '', '']}),
    ("ajoute du pain", {'tags': ['V', '', 'N']})
]
...
def main(lang='fr', output_dir=os.path.basename(__file__)+'_data', n_iter=25):
    ...
    test_text = "je veux rajouter des oeufs à ma liste"
    doc = nlp(test_text)
    print('Tags', [(t.text, t.tag_, t.pos_) for t in doc])

    test_text = "je veux rajouter du poivre à ma liste"
    doc = nlp(test_text)
    print('Tags', [(t.text, t.tag_, t.pos_) for t in doc])
